...
// STAT actions
export const APPLICATIONS_STATS_GET_INITIATED = "APPLICATIONS_STATS_GET_INITIATED";
export const APPLICATIONS_STATS_GET_FAILED = "APPLICATIONS_STATS_GET_FAILED";
export const APPLICATIONS_STATS_GET_SUCCESS = "APPLICATIONS_STATS_GET_SUCCESS";
export const APPLICATIONS_STATS_UPDATE_INITIATED = "APPLICATIONS_STATS_UPDATE_INITIATED";
export const APPLICATIONS_STATS_UPDATE_FAILED = "APPLICATIONS_STATS_UPDATE_FAILED";
export const APPLICATIONS_STATS_UPDATE_SUCCESS = "APPLICATIONS_STATS_UPDATE_SUCCESS";
export const USERS_STATS_GET_INITIATED = "USERS_STATS_GET_INITIATED";
export const USERS_STATS_GET_FAILED = "USERS_STATS_GET_FAILED";
export const USERS_STATS_GET_SUCCESS = "USERS_STATS_GET_SUCCESS";
export const USERS_STATS_UPDATE_INITIATED = "USERS_STATS_UPDATE_INITIATED";
export const USERS_STATS_UPDATE_FAILED = "USERS_STATS_UPDATE_FAILED";
export const USERS_STATS_UPDATE_SUCCESS = "USERS_STATS_UPDATE_SUCCESS";